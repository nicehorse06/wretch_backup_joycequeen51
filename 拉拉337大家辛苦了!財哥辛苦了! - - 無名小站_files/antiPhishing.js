		...
		switch(o.category){
			...
			case 'black':
				panel.setBody('<div class="antiphishing-wrapper"><p class="antiphishing-warning">' + o.message + '</p>' +
					'<span class="antiphishing-note"><a href="http://web.archive.org/web/20131226221735/http://tw.info.yahoo.com/seal/index.html" target="_blank">' + o.note + 
					'</a></span></div>');
				panel.cfg.queueProperty('buttons', [
...
playback timings (ms):
  ...
  esindex: 0.019
  LoadShardBlock: 104.635 (6)
  CDXLines.iter: 66.206 (3)
  load_resource: 113.001
  RedisCDXSource: 0.769
  PetaboxLoader3.datanode: 126.964 (7)
  exclusion.robots: 0.255
  PetaboxLoader3.resolve: 65.232
*/