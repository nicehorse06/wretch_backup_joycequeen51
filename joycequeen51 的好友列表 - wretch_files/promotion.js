YUI.add('promotion', function (Y) {
    ...
    W.promotion = function () {
        ...
        if (!browserUpdated) {
            var htmls = Y.Node.create('<div id="bg_pop" style="width:' + window.screen.width + 'px;height:' + (docHeight > screenHeight ? docHeight : screenHeight) + 'px;position:absolute;z-index:9999999;background:#000;opacity:0.5;filter:alpha(opacity=60);top:0;left:0;"><iframe width="100%" height="100%" style="filter: Alpha(opacity=0.5);"  src=""></iframe></div>'),
                browserUpdated = new Y.Overlay({
                    ...
                    height: '480px',
                    centered: true,
                    bodyContent: '<div id="promotion">' + '<div class="hd_link">' + '<h1>喔喔~~你的瀏覽器已經過期啦！</h1>' + '<h2>享受最不失真的無名>小站瀏覽經驗，現在就升級瀏覽器！</h2></div>' + '<div class="bd_link"></div>' + '<div class="ft_link">' + '<a class="ie" href="http://web.archive.org/web/20131226221702/http://tw.promo.campaign.yahoo.net/yahooie9/index.html" target="_blank"><span></span>下載新版Internet Explorer</a>' + '<a class="firefox" href="http://web.archive.org/web/20131226221702/http://downloads.yahoo.com/tw/firefox/" target="_blank"><span></span>下載新版Firefox</a>' + '<a class="later" href="#"><span></span>下次再說</a></div></div>',
                    visible: false,
                    zIndex: 10000000
                }).render();
        ...
        img.src = 'http://web.archive.org/web/20131226221702/http://www.wretch.cc/ajax/album/ajax_browser_alert.php?' + (new Date()).getTime();
...
/*
     ...
     INTERNET ARCHIVE ON 07:27:22 Dec 30, 2019.
...
playback timings (ms):
  ...
  LoadShardBlock: 140.048 (6)
  CDXLines.iter: 51.662 (3)
  PetaboxLoader3.datanode: 159.399 (7)
  PetaboxLoader3.resolve: 35.451
  esindex: 0.014
