		...
		switch(o.category){
			...
			case 'black':
				panel.setBody('<div class="antiphishing-wrapper"><p class="antiphishing-warning">' + o.message + '</p>' +
					'<span class="antiphishing-note"><a href="http://web.archive.org/web/20131226221657/http://tw.info.yahoo.com/seal/index.html" target="_blank">' + o.note + 
					'</a></span></div>');
				panel.cfg.queueProperty('buttons', [
...
playback timings (ms):
  ...
  esindex: 0.022
  LoadShardBlock: 165.54 (6)
  CDXLines.iter: 53.409 (3)
  load_resource: 81.934
  RedisCDXSource: 2.372
  PetaboxLoader3.datanode: 145.743 (7)
  exclusion.robots: 0.127
  PetaboxLoader3.resolve: 65.195 (2)
*/