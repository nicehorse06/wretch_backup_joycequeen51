...
function check_new_comment_input(msg, msg_over_length)
{
  ...
  if(!cookieActivated()) {
    window.location = "http://web.archive.org/web/20131226221657/http://www.wretch.cc/common/error.php?error=magic";
    return false;
  }
  return true;
}
...
function pic_server_replace(origStr)
{
  ...
  var PicServPat = new RegExp('src="http://web.archive.org/web/20131226221657/http://pic.wretch.cc/([^"\?]+)(gif|jpg|png)"', 'g');
  ...
  {
    m = matchAry[i].replace('http://web.archive.org/web/20131226221657/http://pic.wretch.cc', 'http://web.archive.org/web/20131226221657/http://l.yimg.com/wretch.yimg.com');;
...
function show_external_bookmark(bm_url, bm_title)
{
  ...
  for (i = 0; i < 8; i++)
  {
    ...
    url = url.replace('__U__', encodeURIComponent('http://web.archive.org/web/20131226221657/http://www.wretch.cc/blog/' + bm_url));
    url = url.replace('__T__', encodeURIComponent(bm_title));
//    url = 'http://web.archive.org/web/20131226221657/http://tw.rd.yahoo.com/referurl/wretch/blog/bookmark/' + i + '/*' + url;

    document.write("<a href='" + url + "' target='_blank'><img src='http://web.archive.org/web/20131226221657/http://l.yimg.com/wretch.yimg.com/photos/icon/blog/bookmark/" + img + ".png' width='16' height='16' title='" + name + "' alt='" + name + " BookMark' border='0' /></a>&nbsp;&nbsp;");
  }
}
...
/*
     ...
     INTERNET ARCHIVE ON 07:10:48 Dec 30, 2019.
...
playback timings (ms):
  esindex: 0.014
  RedisCDXSource: 1.323
  LoadShardBlock: 348.369 (6)
  PetaboxLoader3.datanode: 108.421 (7)
  exclusion.robots.policy: 0.229
  CDXLines.iter: 65.118 (3)
  exclusion.robots: 0.248
  load_resource: 77.603
  PetaboxLoader3.resolve: 290.784 (3)
*/