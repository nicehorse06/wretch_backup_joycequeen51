...
var addricon_img = 'http://web.archive.org/web/20131226221657/http://tw.yimg.com/i/tw/lifestyle/map_texticon.gif';
...
function generateAddrHTML(T, MTH) {
    if (MTH.length) {
        ...
        for (I=0;I<SMTH.length;I++) {
            ...
            T = T.replace(new RegExp(A, 'g'), '<a href="http://web.archive.org/web/20131226221657/http://tw.rd.yahoo.com/referurl/wretch/maps/*http://tw.maps.yahoo.com/?ei=utf8&addr=' + encodeURIComponent(A) + '" class="' + addrclass + '" target="_blank" title="前往地圖">' + A.replace(/^(.)/, '<span>$1</span>') + '<img src="' + addricon_img + '" border="0" /></a>');
            AS[A] = 1;
        }
        return T;
    }
...
playback timings (ms):
  ...
  LoadShardBlock: 684.036 (6)
  RedisCDXSource: 2.394
  esindex: 0.051
  load_resource: 109.66
  PetaboxLoader3.resolve: 39.152
  exclusion.robots.policy: 0.288
  PetaboxLoader3.datanode: 714.917 (7)
  CDXLines.iter: 94.165 (3)
*/